<?php 
	...
	if(isset($_REQUEST['addBtn'])){
		$owner_id=mysqli_real_escape_string($_REQUEST['owner_id']);
		$ISBN=mysqli_real_escape_string($_REQUEST['ISBN']);
		$date =  date("Y-m-d h:i:sa");
		$sql="INSERT into ownership values('','$owner_id','','$ISBN','','$date')";
		mysql_query($con,$sql) or die("An error occurs.");
...
<div id="outContainer">
    ...
    <form style="color:#005980;font-weight:bold;">
